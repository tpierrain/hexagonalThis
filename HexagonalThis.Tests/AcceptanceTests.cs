...
namespace HexagonalThis.Tests
{
    public class AcceptanceTests
    {
        ...
        public void Should_give_Verses_when_asked_for_Poetry()
        {
            ...
            // Here, the left-side Adapter is both the test and the unit test framework
        ...
        {
            // IObtainPoems : right-side port
            // Here, the right-side adapter is a Stub (provided by the NSubstitute library)
        ...
        public void Should_provides_verses_when_asked_for_Poetry_through_a_ConsoleAdaper()
        {
            ...
            var publicationStrategy = Substitute.For<IWriteLines>();
        ...
        [Test]
        public void Should_gives_Verses_when_asked_for_Poetry_with_the_support_of_a_FileAdapter()
        {
            // 1. Instantiate right-side adapter(s) ("I want to go outside the hexagon")
